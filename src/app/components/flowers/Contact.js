        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div>
              ...
              <p className="text-gray-600 max-w-md">
                Ready to transform your environment with smart technology? Contact us to discuss your IoT monitoring needs or request a consultation.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Tech Avenue<br />Toronto, ON M5V 2L7</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@datasense.com</p>
                </div>
              </div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-lg shadow-sm">
              {submitted ? (
                <div className="bg-green-50 p-4 rounded text-green-700 text-center">
                ...
                <>
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-colors ${
